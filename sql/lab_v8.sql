...
CREATE TABLE `handbook` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `handbook_id` varchar(45) NOT NULL COMMENT '标号，如“1.3.2”',
...
CREATE TABLE `introduction` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `type` int(11) NOT NULL COMMENT '0：实验室简介，1：关于我们',
...
CREATE TABLE `teacher_has_course` (
  ...
  `teacher_id` varchar(11) NOT NULL COMMENT '教师工号',
  `course_id` varchar(20) NOT NULL COMMENT '课程编号',
  `creator` varchar(11) NOT NULL COMMENT '创建者',
...
-- Dump completed on 2019-09-03 13:43:07
