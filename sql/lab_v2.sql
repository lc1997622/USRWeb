...
CREATE TABLE `achievement` (
  `achievement_id` int(11) NOT NULL AUTO_INCREMENT COMMENT '成果id',
...
CREATE TABLE `contribution` (
  `contribution_id` int(11) NOT NULL AUTO_INCREMENT COMMENT '稿件id',
...
CREATE TABLE `copyright` (
  `copyright_id` int(11) NOT NULL AUTO_INCREMENT COMMENT '著作权id',
...
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `data` (
  `data_id` int(11) NOT NULL AUTO_INCREMENT COMMENT '资料id',
...
CREATE TABLE `dictionary_item` (
  `item_id` int(11) NOT NULL AUTO_INCREMENT COMMENT '字典项目表',
...
CREATE TABLE `dictionary_type` (
  `dic_id` int(11) NOT NULL AUTO_INCREMENT COMMENT '字典类型表',
  `dic_value` int(11) NOT NULL COMMENT '类型id',
...
CREATE TABLE `edu_reform` (
  `edu_reform_id` int(11) NOT NULL AUTO_INCREMENT COMMENT '教改id',
  `name` varchar(100) NOT NULL COMMENT '教改名',
  `type` int(11) NOT NULL COMMENT '0：校级，1：省部，2：国家',
  `year` year(4) NOT NULL COMMENT '发表年份',
  PRIMARY KEY (`edu_reform_id`)
...
CREATE TABLE `international` (
  `international_id` int(11) NOT NULL AUTO_INCREMENT COMMENT '国际合作项目id',
...
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `patent` (
  `patent_id` int(11) NOT NULL AUTO_INCREMENT COMMENT '专利id',
...
CREATE TABLE `project` (
  `project_id` int(11) NOT NULL AUTO_INCREMENT COMMENT '科研项目id',
...
CREATE TABLE `recruit` (
  `recruit_id` int(11) NOT NULL AUTO_INCREMENT COMMENT '招生信息id',
...
CREATE TABLE `textbook` (
  `textbook_id` int(11) NOT NULL AUTO_INCREMENT COMMENT '教材id',
...
-- Dump completed on 2019-09-01 10:13:05
