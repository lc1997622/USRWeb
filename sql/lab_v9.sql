...
CREATE TABLE `achievement` (
  ...
  `modifier` varchar(11) DEFAULT NULL,
...
--
-- Table structure for table `contribution_has_document`
--

DROP TABLE IF EXISTS `contribution_has_document`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `contribution_has_document` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'id',
...
--
-- Dumping data for table `contribution_has_document`
--

LOCK TABLES `contribution_has_document` WRITE;
/*!40000 ALTER TABLE `contribution_has_document` DISABLE KEYS */;
/*!40000 ALTER TABLE `contribution_has_document` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `dictionary_item` (
  ...
  `delete_flag` int(11) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='字典项目表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `handbook` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'id',
  `handbook_id` varchar(45) NOT NULL COMMENT '手册标号，如“1.3.2”',
  `title` varchar(45) NOT NULL COMMENT '手册标题',
...
CREATE TABLE `international` (
  ...
  `name` varchar(100) NOT NULL COMMENT '大学/企业名称',
...
CREATE TABLE `introduction` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'id',
  `type` int(11) NOT NULL COMMENT '简介类型。0：实验室简介，1：关于我们',
  `content` text NOT NULL COMMENT '内容',
  `creator` varchar(11) DEFAULT NULL,
  `create_time` datetime NOT NULL,
  `modifier` varchar(11) DEFAULT NULL,
...
CREATE TABLE `recruit` (
  ...
  `requirement` text NOT NULL COMMENT '招生要求',
  `work_time` varchar(100) NOT NULL COMMENT '工作时间（100字以内）',
  `others` text COMMENT '其他要求，500字以内',
...
CREATE TABLE `student` (
  ...
  `level` int(11) NOT NULL COMMENT '学号第1位，学生层次。1：本科，2：硕士，3：博士',
  `training` varchar(45) NOT NULL COMMENT '学号第2位，培养类别。1：学术，2：专业，3：交换生，8：留学生',
  ...
  `graduation_flag` int(11) NOT NULL COMMENT '0：未毕业，1：毕业',
...
CREATE TABLE `teacher` (
  ...
  `parttime_job` varchar(45) DEFAULT NULL COMMENT '兼职职务',
  `birthday` date DEFAULT NULL COMMENT '生日',
  `email` varchar(45) DEFAULT NULL COMMENT '邮箱',
  `moblie_phone` varchar(45) DEFAULT NULL COMMENT '手机电话，11位。考虑到后期扩展，建议添加国家代码并考虑到各国移动电话的不同编码方式',
...
CREATE TABLE `teacher_has_course` (
  ...
  `teacher_id` varchar(11) NOT NULL COMMENT '教师工号',
  `course_id` varchar(20) NOT NULL COMMENT '课程编号',
  `creator` varchar(11) DEFAULT NULL COMMENT '创建者',
  `create_time` datetime NOT NULL COMMENT '创建时间',
  `modifier` varchar(11) DEFAULT NULL COMMENT '修改者',
  `modify_time` datetime DEFAULT NULL COMMENT '修改时间',
  `delete_flag` int(11) NOT NULL DEFAULT '0' COMMENT '删除标记，默认为0。0：未删除，1：已删除',
  PRIMARY KEY (`id`)
...
CREATE TABLE `user` (
  ...
  `borrow_times` int(11) NOT NULL DEFAULT '0' COMMENT '借阅次数，默认为0，系统限制为2',
  `creator` varchar(11) DEFAULT NULL,
  `create_time` datetime NOT NULL,
  `modifier` varchar(11) DEFAULT NULL,
  `modify_time` datetime DEFAULT NULL,
...
DROP TABLE IF EXISTS `user_has_document`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
--
-- Dumping data for table `user_has_document`
--

LOCK TABLES `user_has_document` WRITE;
/*!40000 ALTER TABLE `user_has_document` DISABLE KEYS */;
/*!40000 ALTER TABLE `user_has_document` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Table structure for table `user_has_handbook`
--

DROP TABLE IF EXISTS `user_has_handbook`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `user_has_handbook` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'id',
  `user_id` varchar(11) NOT NULL COMMENT '用户id',
  `handbook_id` int(11) NOT NULL COMMENT '手册id',
  `creator` varchar(11) DEFAULT NULL,
  `create_time` datetime NOT NULL,
  `modifier` varchar(11) DEFAULT NULL,
  `modify_time` datetime DEFAULT NULL,
  `delete_flag` int(11) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='用户-手册关联表';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `user_has_handbook`
--

LOCK TABLES `user_has_handbook` WRITE;
/*!40000 ALTER TABLE `user_has_handbook` DISABLE KEYS */;
/*!40000 ALTER TABLE `user_has_handbook` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Table structure for table `user_has_introduction`
--

DROP TABLE IF EXISTS `user_has_introduction`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `user_has_introduction` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'id',
  `user_id` varchar(11) NOT NULL COMMENT '用户id',
  `introduction_id` int(11) NOT NULL COMMENT '简介id',
  `creator` varchar(11) DEFAULT NULL,
  `create_time` datetime NOT NULL,
  `modifier` varchar(11) DEFAULT NULL,
  `modify_time` datetime DEFAULT NULL,
  `delete_flag` int(11) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='用户-简介关联表';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `user_has_introduction`
--

LOCK TABLES `user_has_introduction` WRITE;
/*!40000 ALTER TABLE `user_has_introduction` DISABLE KEYS */;
/*!40000 ALTER TABLE `user_has_introduction` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2019-09-04 12:31:51
