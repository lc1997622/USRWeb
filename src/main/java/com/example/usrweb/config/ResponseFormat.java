...
/**
 * @author ：LiChao
 * @date ：Created in 2019/9/3 18:58
 * @description：统一返回客户端数据格式
 * @modified By：
 * @version: 1.0$
 */
...
public class ResponseFormat {
    ...
    public static MyResponse retParam(Integer status, Object data){
        MyResponse json = new MyResponse(status,messageMap.get(status),data);
        return json;
    }
}
