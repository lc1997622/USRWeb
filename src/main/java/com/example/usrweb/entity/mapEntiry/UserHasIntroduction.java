/**
 * @filename:UserHasIntroduction 2019年9月1日
...
public class UserHasIntroduction extends Model<UserHasIntroduction> {

	private static final long serialVersionUID = 1567821401336L;
	...
	@ApiModelProperty(name = "introductionId" , value = "简介id")
